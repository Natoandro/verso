...
writes one structured request record per request to standard error. Logging
defaults to JSON in production and to pretty output for development TTYs (or
plain text when stderr is redirected). The
